...
db_basic::db_basic(usrp_standard_rx *u, unsigned int _which) : ossie_db_base(u, _which)
{

}

db_basic::db_basic(usrp_standard_tx *u, unsigned int _which) : ossie_db_base(u, _which)
{
